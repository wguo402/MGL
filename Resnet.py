    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train']:
            ...
            if phase == 'test' and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
        torch.save(model.state_dict(), 'resnet50_c132.pth')
        print()
...
#         config)
# pretrainde_dict = (torch.load('/home/guow/food/I500code/premodle/hrnetv2_w64_imagenet_pretrained.pth'))
...
model_ft = Share_convs(model_ft,132)
model_ft = nn.DataParallel(model_ft)
# model_ft.load_state_dict(pretrainde_dict)
model_ft = model_ft.to(device)
model_ft.load_state_dict(torch.load('/home/guow/food/Finetune-pytorch/Food101-resnet101/resnet50_c132.pth'))
