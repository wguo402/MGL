...
def opts():
    ...
    parser.add_argument('--second-order-grad', default=True, action='store_true',
    ...
    parser.add_argument('--epochs', '-e', type=int, default=81325, help='Number of epochs to train')
    ...
    parser.add_argument('--schedule', type=int, nargs='+', default=[12421 ,24842, 30000],
