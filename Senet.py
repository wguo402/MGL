    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train']:
            ...
            if phase == 'test' and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
        torch.save(model.state_dict(), 'senet50_c132.pth')
        print()
...
model_ft = SENet(block=SEResNetBottleneck,
                              layers=[3, 4, 6, 3],
                              groups=1,
                              reduction=16,
                              dropout_p=None,
...
pretrainde_dict = (torch.load('/home/guow/.cache/torch/checkpoints/se_resnet50-ce0d4300.pth'))
