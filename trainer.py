...
def train(train_loader_source, train_loader_source_batch, train_loader_target, train_loader_target_batch, model_source, model_target, criterion, optimizer, epoch, args, meta_train_lr):
    ...
    target_target_train = target_target_train.cuda()
    ...
    target_target_mtrain = target_target_mtrain.cuda()
    ...
    if args.first_meta_update:  ## Also apply the first gradient for parameter update, We Do Not adopt this strategy. flase
        count = 0
...
def adjust_learning_rate(optimizer, epoch, args):
    ...
    exp =  epoch > args.schedule[2] and 3 or epoch > args.schedule[1] and 2 or epoch > args.schedule[0] and 1 or 0
