...
train_loader = torch.utils.data.DataLoader(dataset=train_dataset, batch_size=50*2, shuffle=True,  num_workers=4)
test_loader = torch.utils.data.DataLoader(dataset=test_dataset,  batch_size=50*2,  shuffle=False, num_workers=2)
...
def train_model(model, criterion, optimizer, scheduler, num_epochs=25):
    ...
    torch.save(model.state_dict(), 'hr_label_smooth_net.pth')
    return model
