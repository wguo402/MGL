    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train']:
            ...
            if phase == 'test' and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
        torch.save(model.state_dict(), 'vgg16_no_bn_c132.pth')
        print()
...
# pretrainde_dict = (torch.load('/home/guow/.cache/torch/checkpoints/vgg16_bn-6c64b313.pth'))
#
...
# model_ft = Share_convs(model_ft,71)
